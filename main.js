...
array_1=[quick_draw_data_set];
random_number=Math.floor((Math.random()*array_1.length)+1);
console.log(random_number);
random_number=quick_draw_data_set;
document.getElementById("sketch_given").innerHTML="quick_draw_data_set";
timer_counter=0;
timer_check="";
drawn_sketch="";
answer_holder="";
sketch="";
score=0;
quick_draw_data_set_lenght=quick_draw_data_set.length;

function updateCanvas(){
    
    random_number=Math.random(quick_draw_data_set_lenght);
}
...
function draw(){
    if(drawn_sketch==sketch){
        ...
        timer_counter= timer_counter++;
        getElementById("timer").innerHTML="Timer:"+timer_counter;
        console.log(timer_counter);
        if(400<timer_counter){
timer_counter=0;
